# Push Notifs For Rugplay
A self-host, vibe-coded 🥀 Python script that use ntfy.sh to push notification to your devices!
# How to run
## 1. Get Linux
get linux, either WSL (Windows) or Termux (Android) works fine
## 2. Install packages
install python and... uh i forgot, maybe asyncio, json, requests, websockets?. ts script was 7 months ago. ask gemini for instructions lmao 
...
type in the topic you noted down earlier, then subcribe to it
## 6. Run the script
